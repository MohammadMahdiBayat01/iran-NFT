...
<nav class="bg-none h-16">
    ...
    <div class="flex flex-wrap justify-between mx-auto z-10 relative">
        <a href="#" class="flex items-center rtl:space-x-reverse w-3/12">
            <span class="self-center text-4xl bold whitespace-nowrap text-white">Iran NFT</span>
        </a>
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse h-16 w-3/12">
